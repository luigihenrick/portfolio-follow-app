...
class AlphaVantageService {
  ...
  static Future<PriceHistoryDaily> fetchPriceHistoryData(String symbol) async {
    final response = await http.get(
        'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=$symbol&apikey=${GlobalVariables.alphaVantageKey}');
  ...
  static Future<Quote> fetchQuoteData(String symbol) async {
    final response = await http.get(
        'https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=$symbol&apikey=${GlobalVariables.alphaVantageKey}');
